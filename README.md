...
To run this project locally, create a project on [firebase console](https://console.firebase.google.com/), turn on firebase google authentication and cloud firestore, get your firebase config object and create environment variables for config.js file. Put your key-values from your config object in a .env file and run npm install. Refer to .env.example file for sample format.
